...
@interface CameraCloudNewViewController ()<UITableViewDelegate, UITableViewDataSource, UICollectionViewDelegate, UICollectionViewDataSource,TuyaTimelineViewDelegate,TuyaSmartCloudManagerDelegate>
...
- (void)gotoCloudServicePanel {
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1.5 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        [self showAlertWithMessage:NSLocalizedStringFromTable(@"please import TuyaSmartCloudServiceBizBundle", @"IPCLocalizable", @"")];
    });
