...
@interface CameraViewController ()<CameraBottomSwitchViewDelegate, ThingSmartCameraDelegate, CameraControlViewDelegate, ThingSmartCameraDPObserver, UIScrollViewDelegate>
...
- (instancetype)initWithDeviceId:(NSString *)devId {
    if (self = [super initWithNibName:nil bundle:nil]) {
        ...
        _dpManager = [[ThingSmartCameraDPManager alloc] initWithDeviceId:devId];
...
- (void)hdAction {
    ThingSmartCameraDefinition definition = !self.isHD ? ThingSmartCameraDefinitionHigh : ThingSmartCameraDefinitionStandard;
...
- (void)enableMute:(BOOL)isMute {
    [self.cameraType enableMute:isMute forPlayMode:ThingSmartCameraPlayModePreview];
}
...
- (void)camera:(id<ThingSmartCameraType>)camera definitionChanged:(ThingSmartCameraDefinition)definition{
    _HD = definition >= ThingSmartCameraDefinitionHigh;
