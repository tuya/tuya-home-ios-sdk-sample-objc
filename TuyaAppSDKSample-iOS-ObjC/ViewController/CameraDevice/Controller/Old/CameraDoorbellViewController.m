...
@interface CameraDoorbellViewController ()<ThingSmartCameraDelegate, ThingSmartCameraDPObserver>
...
- (void)cameraDidBeginPreview:(id<ThingSmartCameraType>)camera {
    ...
    [self.cameraType enableMute:NO forPlayMode:ThingSmartCameraPlayModePreview];
    [self talkAction];
}
