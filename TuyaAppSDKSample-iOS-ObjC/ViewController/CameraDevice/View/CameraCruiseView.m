...
@interface CameraCruiseView ()<ThingSmartPTZManagerDeletate>
...
- (void)updateCruiseModeValueButton {
    ThingSmartPTZControlCruiseMode cruiseMode = [self.ptzManager getCurrentCruiseMode];
    NSString *modeStr = (cruiseMode == ThingSmartPTZControlCruiseModePanoramic) ? NSLocalizedStringFromTable(@"Panoramic", @"IPCLocalizable", @""):NSLocalizedStringFromTable(@"Collection Points", @"IPCLocalizable", @"");
    [self.cruiseModeValueButton setTitle:modeStr forState:UIControlStateNormal];
}

- (void)updateCruiseTimeValueButton {
    ThingSmartPTZControlCruiseTimeMode timeMode = [self.ptzManager getCurrentCruiseTimeMode];
    NSString *timeStr = @"";
    if (timeMode == ThingSmartPTZControlCruiseTimeModeAllDay) {
...
- (void)cruiseModeButtonClick:(UIButton *)btn {
    ...
    self.selectView.index = (cruiseMode == ThingSmartPTZControlCruiseModePanoramic) ? 0:1;
    ...
    self.selectView.didClickConfirmBtn = ^(CameraCruiseSelectView * _Nonnull view, NSInteger index) {
        ThingSmartPTZControlCruiseMode cruiseMode = index==0 ? ThingSmartPTZControlCruiseModePanoramic:ThingSmartPTZControlCruiseModeCollectionPoint;
...
- (void)cruiseTimeButtonClick:(UIButton *)btn {
    ...
    self.selectView.index = (timeMode == ThingSmartPTZControlCruiseTimeModeAllDay) ? 0:1;
    ...
    self.selectView.didClickConfirmBtn = ^(CameraCruiseSelectView * _Nonnull view, NSInteger index) {
        ...
        ThingSmartPTZControlCruiseTimeMode timeMode = index==0 ? ThingSmartPTZControlCruiseTimeModeAllDay:ThingSmartPTZControlCruiseTimeModeCustom;
