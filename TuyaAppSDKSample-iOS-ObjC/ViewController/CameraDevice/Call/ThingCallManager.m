...
@interface ThingCallManager () <ThingSmartCallChannelDelegate,ThingSmartCallChannelDataSource>

@property (nonatomic, strong) CameraCallInterfaceManager *interfaceManager;

@end

@implementation ThingCallManager

+ (void)load {
    [ThingCallManager.sharedInstance configurateCallSDK];
}
...
+ (instancetype)sharedInstance {
    static ThingCallManager *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[ThingCallManager alloc] init];
    });
    return instance;
}
