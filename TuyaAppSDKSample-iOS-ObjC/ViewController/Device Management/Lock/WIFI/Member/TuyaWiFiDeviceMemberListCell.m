//
//  TuyaWiFiDeviceMemberListCell.m
...
@interface TuyaWiFiDeviceMemberListCell()
...
@implementation TuyaWiFiDeviceMemberListCell
...
- (void)reloadData:(ThingSmartLockMemberModel *)model{
    ...
    NSString *userContact = model.contact;
    NSString *avatarUrl = model.avatarUrl;
    int userType = (int)model.userType;
