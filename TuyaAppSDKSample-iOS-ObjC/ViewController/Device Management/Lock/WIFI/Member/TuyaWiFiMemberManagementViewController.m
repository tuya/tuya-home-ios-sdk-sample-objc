//
//  TuyaWiFiMemberManagementViewController.m
...
@interface TuyaWiFiMemberManagementViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation TuyaWiFiMemberManagementViewController
...
- (void)viewDidLoad {
    ...
    self.dicData = @{
        @"WiFi门锁":@[@"获取门锁家庭成员列表",@"创建单个家庭门锁成员"],
    };
}

- (void)gotoMemberList{
    TuyaWiFiMemberListViewController *vc = [[TuyaWiFiMemberListViewController alloc] init];
    vc.devId = self.devId;
