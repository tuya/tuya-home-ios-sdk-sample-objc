...
@interface TuyaLockDeviceListViewController ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)viewDidLoad {
    ...
    self.title = [NSString stringWithFormat:@"%@(%@)",@"当前BLE门锁",([self.bleDevice isBLEConnected] ? @"在线":@"离线")];
    ...
    //面板成员查询
//    [self.bleDevice getMemberListWithSuccess:^(NSArray<TuyaSmartBLELockMemberModel *> * _Nonnull members) {
//        self.memberList = [[NSMutableArray alloc] initWithArray:members];
