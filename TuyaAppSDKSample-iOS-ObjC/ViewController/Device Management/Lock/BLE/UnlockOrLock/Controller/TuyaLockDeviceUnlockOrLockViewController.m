...
@interface TuyaLockDeviceUnlockOrLockViewController ()<UITableViewDelegate,UITableViewDataSource>
    ...
    switch (indexPath.row) {
        case 0: {//蓝牙开锁
            [self.bleDevice getCurrentMemberDetailWithDevId:self.devId gid:self.bleDevice.deviceModel.homeId success:^(NSDictionary *dict) {
                ...
                [weakSelf_ThingSDK.bleDevice bleUnlock:bleUnlock success:^{
        ...
        case 2://远程解锁
        {
            [self.bleDevice remoteSwitchLock:^(BOOL result) {
        ...
        case 3://远程关锁
        {
            [self.bleDevice manualLockWithStatus:^{
        ...
        case 6:
        {   
            [self.bleDevice getLockDeviceConfigWithProductId:self.bleDevice.deviceModel.productId
