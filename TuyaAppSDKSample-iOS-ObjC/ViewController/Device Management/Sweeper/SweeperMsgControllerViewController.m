...
//
//  Copyright (c) 2014-2022 Thing Inc. (https://developer.Thing.com/)

#import "SweeperMsgControllerViewController.h"
#import <ThingSmartSweeperKit/ThingSmartSweeperDevice.h>
#import <ThingSmartSweeperKit/ThingSmartSweeperRecordDetail.h>
#import <ThingSmartSweeperKit/ThingSmartSweeperRecordList.h>
...
@property (strong, nonatomic) ThingSmartSweeperDevice *sweeperDev;
...
- (void)viewDidLoad {
    ...
    self.sweeperDev = [ThingSmartSweeperDevice new];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.row) {
        case 0: {
            //查询最新一次清扫记录
            [self.sweeperDev queryLatestCleanRecord:model.devId start:@"" size:100 complete:^(ThingSmartSweeperRecordDetail * _Nonnull model, NSError * _Nonnull error) {
                NSLog(@">>>: %@", model);
        ...
        {
            //历史清扫记录列表
            [self.sweeperDev getHistoryCleanRecordList:model.devId offset:0 limit:50  startTime:0 endTime:0 complete:^(NSArray<ThingSmartSweeperRecordList *> * _Nonnull list, NSError * _Nonnull error) {
                ...
                NSString * subrecordId = [ThingSmartSweeperRecordList subRecordIdObtainFromValue:@"20210826052504804100145"];
        ...
        case 2:
        {
            ...
            //清扫记录详情
            [self.sweeperDev getCleanRecordDetail:model.devId subRecordId:self.subRecordId.integerValue start:@"" size:50 complete:^(ThingSmartSweeperRecordDetail * _Nonnull model, NSError * _Nonnull error) {
                NSLog(@">>>: %@", model);
            }];
        }
            break;
